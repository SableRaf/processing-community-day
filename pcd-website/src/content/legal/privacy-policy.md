...
When you volunteer to host a Processing Community Day event, you submit information about yourself and your event through our public [GitHub repository](https://github.com/processing/processing-community-day) and/or the [Processing Discourse forum](https://discourse.processing.org). This information may include:
...
- **Netlify's privacy policy:** [netlify.com/privacy](https://www.netlify.com/privacy/)
...
- **Fathom's own privacy policy:** [usefathom.com/legal/privacy](https://usefathom.com/legal/privacy)
...
| --- | --- | --- |
| **Netlify** | Hosting and serving the Site; its servers process request data (including IP addresses) to deliver pages | [netlify.com/privacy](https://www.netlify.com/privacy/) |
| **Fathom Analytics** | Cookieless, anonymous website analytics | [usefathom.com/legal/privacy](https://usefathom.com/legal/privacy) |
| **GitHub** (Microsoft) | Hosting the repository where event submissions and site content are stored | [docs.github.com/privacy](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement) |
| **Discourse forum** (discourse.processing.org) | Community forum used to coordinate events | [Discourse privacy](https://discourse.processing.org/privacy) |
| **CARTO / OpenStreetMap** | Map tiles used to display the event map | [CARTO](https://carto.com/privacy/) · [OpenStreetMap](https://wiki.osmfoundation.org/wiki/Privacy_Policy) |
