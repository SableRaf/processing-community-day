...
| `zine-build.test.mjs` | Published cards loaded from files, frontmatter ordering, the single submission card, download metadata, accessible cover rendering, emitted local assets, and source links |
